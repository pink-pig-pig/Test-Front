          ...
          <q-btn type="a" target="_blank" unelevated size="sm" dense round
            ...
            <q-avatar size="sm" text-color="primary">
              ...
              <q-tooltip v-if="$q.screen.gt.sm">
                {{ $t('StandardLayout.gitlabAddress') }}
              </q-tooltip>
            </q-avatar>
          </q-btn>
          <q-btn unelevated size="sm" dense round @click="copyName('zhuzhuxia')">
            <q-avatar size="sm">
              <q-icon class="iconfont iconqq text-primary" />
              <q-tooltip v-if="$q.screen.gt.sm">
                {{ $t('StandardLayout.clickToCopyMyNameToKim') }}
              </q-tooltip>
            </q-avatar>
          </q-btn>
          <q-btn
            ...
            <q-chip dense color="white" class="cursor-pointer q-ml-sm">
              <span
                ...
                style="
                  ...
                  overflow: hidden;
                "
              >{{ $t('StandardLayout.personInfo') }}</span
              >
              <q-menu
                :offset="[0, 26]"
              ...
              >
                <q-list dense>
                  <q-item clickable v-close-popup to="/account/center">
                    ...
                    <q-item-section>{{ $t('StandardLayout.personInfo') }}</q-item-section>
                  </q-item>
    ...
    >
      <div class="q-my-lg">
        <div class="text-center q-mb-sm">
          <span class="inline-block q-mr-sm">QA Front PRO</span>
          ...
          <span class="inline-block q-ml-sm">QA</span>
        </div>
        <div class="text-center">{{ `Copyright@2023 QA ${$t('StandardLayout.experienceTheTechnicalDepartment')}` }}
        </div>
      </div>
    </q-footer>
    <q-drawer
      ...
      >
        <div class="bg-transparent q-px-sm q-gutter-x-sm">
          <q-avatar class="q-mb-sm">
            <q-img style="width: 40px" src="imgs/ks-head.png" />
          </q-avatar>
          <div class="text-body1 inline-block text-primary">
            <strong>QA Front PRO</strong>
          </div>
        </div>
      </div>
      <div
